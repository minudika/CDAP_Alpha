...
public class FileUploadController {
    ...
    public String getSelectedFile(@RequestParam("file") String file , @RequestParam("tableName") String tableName) throws IOException, JSONException, InterruptedException {
        Preprocessor.process(file,tableName);
